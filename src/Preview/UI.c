...
#define UI_CLR_TILE "\033[38;5;222m"
...
static  void draw_horizontal(int row, int form_col, int to_col, const char*glyph) {
    printf("\033[%d;%dH", row, form_col);
    for (int col =form_col; col <= to_col; col++) {
        fputs(glyph, stdout);
    }
}
